...
// FORCE CLEAN output directory - delete everything
function forceCleanOutputDirectory() {
    try {
        console.log('🔥 FORCE CLEANING OUTPUT DIRECTORY...');
        ...
        console.error('❌ ERROR in force cleaning:', error);
    }
}
...
app.post('/process', upload.array('images'), async (req, res) => {
    try {
        ...
        // FORCE CLEAN output directory BEFORE processing
        forceCleanOutputDirectory();
...
app.post('/clean', (req, res) => {
    try {
        forceCleanOutputDirectory();
        res.json({ success: true, message: 'Output directory force cleaned' });
    } catch (error) {
...
// Start server
app.listen(PORT, () => {
    console.log(`🚀 ULTIMATE SERVER running at http://localhost:${PORT}`);
    console.log(`📁 Output directory: ${outputDir}`);
    console.log('🔗 Test ZIP export: http://localhost:' + PORT + '/export');
    console.log('🔥 FORCE CLEANING ENABLED - All old files deleted before processing');
